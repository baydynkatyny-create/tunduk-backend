...
function buildSpeechInput(text) {
  ...
  if (style === "poem") {
    return (
      "Сахнада турган акын сыяктуу, эркин жана күчтүү дем менен, жүрөккө " +
      "жеткире, ички сезимди толук ачып, ырдын муздарын жана дем алыш " +
      "белгилерин сактап, кээ бир сөздөрдү басым менен, толкундануу менен " +
      "оку:\n\n" + text
    );
  }
  if (style === "tale") {
